...
public class Utils {
    ...
    public static String QUERY_PARAMS = "&format=json&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback=";
    ...
    public static ContentProviderOperation buildBatchOperation(JSONObject jsonObject) throws StockNotFoundException {
