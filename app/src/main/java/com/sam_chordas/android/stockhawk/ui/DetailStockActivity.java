...
public class DetailStockActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static Intent getStartActivityIntent(Context context, String currency) {
        ...
        intent.putExtra(DetailStockActivity.STOCK_SYMBOL, currency);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currency = getIntent().getStringExtra(STOCK_SYMBOL);
    ...
    public void renderChart(Cursor data) {
        ...
        lineSet.setColor(ContextCompat.getColor(this, R.color.line_color))
                .setFill(ContextCompat.getColor(this, R.color.line_fill))
                .setDotsColor(ContextCompat.getColor(this, R.color.line_color))
                .setThickness(4)
        ...
        if (lineSet.size() > 1) {
            ...
            Toast.makeText(this, getString(R.string.no_stock_data), Toast.LENGTH_SHORT).show();
        }
    }
